...
{
    const string TitleLabel = "Total Go Trials: {0} Total No-Go Trials {1} Catch Trials ({2} / {3}) \nTotal Rewards: {4}";
    ...
    public override void Load(IServiceProvider provider)
    {
        ...
        graph.GraphPane.Title.Text = string.Format(TitleLabel, 0, 0, 0, 0, 0);
